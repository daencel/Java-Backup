...
public class Song {
	 ...
	 * @param a Erscheinungsjahr
	 */
	public void setErscheinungsjahr(int a) {
		if (a > 0) {
	...
	/**
	 * Vergleicht das Lied mit dem uebergebenen Lied b und gibt true oder false zurueck
	...
	public Song clone() {
		Song neu = new Song();
		neu.setAlbum(this.album);
		neu.setErscheinungsjahr(this.erscheinungsjahr);
		neu.setInterpret(this.interpret);
		neu.setTitle(this.title);
		return neu;
	}
	...
	/**
	 * Gibt das Lied als String mit: Titel, Album, Interpret und Erscheinungsjahr zurueck
	 */
	@Override
