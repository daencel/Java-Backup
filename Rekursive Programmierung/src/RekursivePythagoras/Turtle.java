...
/**
 * 
 * @author Horst Gierhardt, Version vom 31.10.2004 Quelle:
...
class Turtle {
	...
	/**
	 * In der linken oberen Ecke ist der Punkt (0|0). Positive x-Koord. sind rechts
	 * davon, positive y-Koord. sind darunter. x und y sind die Koordinaten des
	 * Startpunktes. richtung ist der anfaengliche Blickwinkel (0: nach rechts)
	 * 
	 * @param cont
	 * @param x
	 * @param y
	 ...
	 * Bildschirmkoordinaten ist. Der Startpunkt der Turtle ist nach der Definition
	 * des KOS in der Mitte des Bildschirms. Der aktuelle Winkel bleibt erhalten
	 * 
	 * @param xMin
	 * @param xMax
	 * @param yMin
	 ...
	 * Andere Farben kann man z.B. mit stiftfarbe (new Color(int rot, int gruen, int
	 * blau)); erzeugen. Die Werte fuer rot, gruen und blau müssen im Bereich
