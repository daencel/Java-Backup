...
public class JPGImageCompress {
	...
	public static void main(String[] args) throws IOException {
		BufferedImage image = ImageIO.read(new File(
				"C:\\Users\\Daniel Lechner\\eclipse-workspace\\JPG-Compression\\src\\net\\tfobz\\jpgcompression\\image.jpg"));
	 ...
	 * @throws IOException
	 */
	public static void compressImage(BufferedImage image, String filename, double quality) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static BufferedImage compressImage(BufferedImage image, double quality) throws IOException {
