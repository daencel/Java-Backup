...
public interface MeinIterator {
	...
	/**
	 * Fügt nach dem Element auf dem der Iterator zeigt das übergebene Element ein
	 * 
	 ...
	 * @return false falls das übergebene Element null ist, falls die Liste leer
	 *         ist, oder noch nie mit naechstesElement() ein Element angesprungen
	 *         wurde, oder über das Listenende hinausgelesen wurde
	 */
