 ...
 * <ul>
 * 	<li>
 * 		Jedes Konto erhaelt eine eindeutige Kontonummer
 * 	</li>
 * 	<li>
 * 		Fuer alle Konten wird ein Startzinssatz vergeben, der beim Anlegen eines Kontos
 * 		fuer das Konto eingestellt wird
 * 	</li>
 * 	<li>
 * 		Jedes Konto verfuegt ueber einen Kontostand
 * 	</li>
 * 	<li>
 ...
 * 	</li>
 * 	<li>
 * 		Vom Konto kann ein Betrag auf ein anderes Konto ueberwiesen werden
 * 	</li>
 * </ul>
 *
 * @author Michael Wild
...
public abstract class Konto {
    ...
    /**
     * Gibt den Zinssatz vor, der jedem Konto beim Anlegen automatisch zugewiesen
     * wird.
     */
     ...
     * Konstruktor
     *
     * Beim Anlegen erhölt das Konto eine eindeutige Kontonummern und der Zinssatz
     * wird übernommen. Es wird jedem neuen Konto eine fortlaufende Kontonummer
     * gegeben. Dabei wird keine Kontonummer doppelt vergeben. Eine Kontonummer
     * eines gelöschten Kontos darf nicht mehr verwendet werden. Weiters wird für
     * das Konto der Zinssatz gesetzt, welcher durch setStartzinssatz für die
     * gesamte Klasse gesetzt wurde. Der Kontostand wird auf 0 initialisiert
     */
    public Konto() {
    ...
    /**
     * Merkt sich für die Klasse den Startzinssatz. Wird ein Konto angelegt, so wird
     * der durch diese Methode eingestellte Startzinssatz dem Konto zugewiesen. Der
     * Zinssatz eines neu angelegtem Kontos wird durch den Startzinssatz
     * initialisiert
     *
    ...
    /**
     * Auf das Konto wird gebucht und damit der Kontostand geändert. Wird ein
     * negativer Betrag angegeben, so bedeutet dies, dass vom Konto abgebucht wird.
     * Positive Beträge bedeuten eine Erhöhung des Kontostandes
     *
     * @param betrag der zu verbuchende positive oder negative Betrag
     * @throws KontoException wird aus Kompatiblitätsgründen zu Überlagernden
     *                        Methoden eingef�hrt
     */
     ...
     * Parameterliste angegebene Konto den angegebenen Betrag. Dabei wird der Betrag
     * vom Konto abgebucht und zum Übergebenen Konto dazugebucht
     *
     * @param k      jenes Konto auf welches überwiesen wird
     * @param betrag der Überwiesen wird
     * @throws KontoException wird ausgelöst, wenn der zu überweisende Betrag
     *                        negativ ist oder wenn kein Konto übergeben wurde
     */
    public void ueberweisen(Konto k, double betrag) throws KontoException {
        if (k == null)
            throw new KontoException("Kein Konto wurde uebergeben");
        if (betrag <= 0)
    ...
    /**
     * Ausgabe der Kontodaten. Es wird die Kontonummer, der Kontostand, der
     * Zinssatz, die Zinsen und die Spesen des Kontos ausgegeben
     *
     * @return die Stringentsprechung des Kontos
     */
    public String toString() {
        return "KontoNummer: " + this.kontonummer + " Kontostand: " + this.kontostand + " Zinssatz: " + this.zinssatz
                + " Zinsen: " + this.getZinsen() + " Spesen: " + this.getSpesen();
    }
}